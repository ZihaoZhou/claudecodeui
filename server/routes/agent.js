 ...
 * POST /api/agent
 *
 * Trigger a Claude agent to work on a project.
 ...
 *
 * @param {string} provider - (Optional) AI provider. Only 'claude' is supported.
 *                           Default: 'claude'
 *
 ...
 *
 *                        Models: 'sonnet' (default), 'opus', 'haiku', 'opusplan', 'sonnet[1m]'
 *
